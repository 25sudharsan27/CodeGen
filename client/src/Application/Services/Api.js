...
const userLogOut = ()=>API.post("/api/auth/logout",{headers:{'Content-Type':"application/json"}})
...
const deleteSession = (id)=>API.delete("/api/user/session/"+id,{headers:{'Content-Type':"application/json"}});

export {userLogin,userSignup,handlePrompt,getSessions,getSessionDetail,deleteSession,userLogOut};